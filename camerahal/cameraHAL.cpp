 ...
 * Copyright (C) 2012 Tomasz "Dorregaray" Rostanski
 *
                       ...
                       hw_device_t** device)
{
    ...
    if (name != NULL) {
        ...
        num_cameras = camera_get_number_of_cameras();/*HAL_getNumberOfCameras();*/
...
#define HTC_SWITCH_CAMERA_FILE_PATH "/sys/android_camera2/htcwc"
        ...
        *device = &priv_camera_device->base.common;
        ...
        camera = /*HAL_*/openCameraHardware(cameraid);
...
int camera_get_number_of_cameras(void)
{
    int num_cameras = /*HAL_getNumberOfCameras()*/1;
