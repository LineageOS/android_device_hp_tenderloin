                             ...
                             int index)
{
    ...
    /* The Android sensors coordinate system is based on the natural orientation
     * of the device which is portrait for phones and landscape for tablets.
     * However in the WebOS natural orientation is portrait so we need to swap
     * the X and Y axis to match the Android coordinate system.
     */
